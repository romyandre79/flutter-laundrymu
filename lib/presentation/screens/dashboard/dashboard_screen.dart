...
class _DashboardScreenState extends State<DashboardScreen> {
                              ...
                              content: Column(
                                ...
                                children: [
                                  ListTile(
                                    ...
                                    onTap: () {
                                      context.read<SyncCubit>().goOnline();
                                      Navigator.pop(ctx);
                                    },
                                  ),
                                  ListTile(
                                    ...
                                    onTap: () {
                                      context.read<SyncCubit>().goOffline();
                                      Navigator.pop(ctx);
                                    },
                                  ),
                                  ListTile(
                                  ...
                                  ListTile(
                                    ...
                                    onTap: () async {
                                      Navigator.pop(ctx);
                                      final logPath = await context.read<SyncCubit>().getLogPath();
                                      if (context.mounted) {
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          SnackBar(
                                            content: Text('Log file: $logPath'),
  ...
  void _showUrlConfigDialog(BuildContext context) {
    ...
    final currentUrl = settingsCubit.currentInfo?.baseUrl ?? AppConstants.defaultBaseUrl;
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (url.isNotEmpty) {
                settingsCubit.updateBaseUrl(url);
                Navigator.pop(dialogContext);
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Base URL diupdate ke: $url'),
